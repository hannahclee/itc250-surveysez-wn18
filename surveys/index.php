<?php
/**
* index.php is the first page of our survey sez application it's based on demo_list_pager
 ...
 * 
 * @package SurveySez
 * @author Hannah Lee <bananapea@gmail.com>
 * @version 0.1
...
$config->metaKeywords = 'Survey,PHP,Fun,'. $config->metaKeywords;
